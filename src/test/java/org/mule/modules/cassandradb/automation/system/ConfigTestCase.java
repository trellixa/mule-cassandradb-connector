...
public class ConfigTestCase {
    ...
    public void shouldConnect_Using_AdvancedParams() throws Exception {
        AdvancedConnectionParameters advancedParams = new AdvancedConnectionParameters(ProtocolVersion.V3, CLUSTER_NAME, MAX_WAIT, ProtocolOptions.Compression.NONE, false);
