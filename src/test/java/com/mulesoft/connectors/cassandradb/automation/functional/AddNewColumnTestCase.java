...
public class AddNewColumnTestCase extends AbstractTestCases {
    ...
    public void testAddNewColumnOfPrimitiveTypeWithSuccess() {
        try {
            addNewColumn(TestDataBuilder.TABLE_NAME_1, testKeyspace, TestDataBuilder.getAlterColumnInput(TestDataBuilder.getRandomColumnName(), TEXT));
        } catch (Exception e) {
            fail();
        }
    }
    ...
    public void testAddNewColumnWithSameName() {
        try{
            addNewColumn(TestDataBuilder.TABLE_NAME_1, testKeyspace, TestDataBuilder.getAlterColumnInput(TestDataBuilder.VALID_COLUMN_1, TEXT));
        } catch (Exception e){
