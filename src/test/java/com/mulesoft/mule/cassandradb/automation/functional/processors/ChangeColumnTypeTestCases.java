...
//        cassClient.addNewColumn(ConstantsTest.TABLE_NAME_1, cassConfig.getKeyspace(), ConstantsTest.VALID_COLUMN_1, DataType.text());
//    }
//
//    @AfterClass
...
////        cassClient.addNewColumn(ConstantsTest.TABLE_NAME_1, cassConfig.getKeyspace(), columnName, DataType.ascii());
//        getConnector().changeColumnType(ConstantsTest.TABLE_NAME_1, TestDataBuilder.getAlterColumnInput(ConstantsTest.DUMMY_PARTITION_KEY, ColumnType.BLOB));
//    }
//
//    @Test
...
//        cassClient.addNewColumn(ConstantsTest.TABLE_NAME_1, cassConfig.getKeyspace(), columnName, DataType.ascii());
//        getConnector().changeColumnType(ConstantsTest.TABLE_NAME_1, TestDataBuilder.getAlterColumnInput(columnName, ColumnType.TEXT));
//    }
//
//    @Test
...
//        cassClient.addNewColumn(ConstantsTest.TABLE_NAME_1, cassConfig.getKeyspace(), columnName, DataType.ascii());
//        getConnector().changeColumnType(ConstantsTest.TABLE_NAME_1, TestDataBuilder.getAlterColumnInput(columnName, ColumnType.VARCHAR));
//    }
//
//    @Test
...
//        cassClient.addNewColumn(ConstantsTest.TABLE_NAME_1, cassConfig.getKeyspace(), columnName, DataType.bigint());
//        getConnector().changeColumnType(ConstantsTest.TABLE_NAME_1, TestDataBuilder.getAlterColumnInput(columnName, ColumnType.BLOB));
//    }
//
//    @Test
...
//        cassClient.addNewColumn(ConstantsTest.TABLE_NAME_1, cassConfig.getKeyspace(), columnName, DataType.bigint());
//        getConnector().changeColumnType(ConstantsTest.TABLE_NAME_1, TestDataBuilder.getAlterColumnInput(columnName, ColumnType.TIMESTAMP));
//    }
//
//    @Test
...
//        cassClient.addNewColumn(ConstantsTest.TABLE_NAME_1, cassConfig.getKeyspace(), columnName, DataType.bigint());
//        getConnector().changeColumnType(ConstantsTest.TABLE_NAME_1, TestDataBuilder.getAlterColumnInput(columnName, ColumnType.VARINT));
//    }
//
//    @Test
...
//        cassClient.addNewColumn(ConstantsTest.TABLE_NAME_1, cassConfig.getKeyspace(), columnName, DataType.cint());
//        getConnector().changeColumnType(ConstantsTest.TABLE_NAME_1, TestDataBuilder.getAlterColumnInput(columnName, ColumnType.BLOB));
//    }
//
//    @Test
...
//        cassClient.addNewColumn(ConstantsTest.TABLE_NAME_1, cassConfig.getKeyspace(), columnName, DataType.text());
//        getConnector().changeColumnType(ConstantsTest.TABLE_NAME_1, TestDataBuilder.getAlterColumnInput(columnName, ColumnType.BLOB));
//    }
//
//    @Test
...
//        cassClient.addNewColumn(ConstantsTest.TABLE_NAME_1, cassConfig.getKeyspace(), columnName, DataType.timestamp());
//        getConnector().changeColumnType(ConstantsTest.TABLE_NAME_1, TestDataBuilder.getAlterColumnInput(columnName, ColumnType.BIGINT));
//    }
//
//    @Test
...
//        cassClient.addNewColumn(ConstantsTest.TABLE_NAME_1, cassConfig.getKeyspace(), columnName, DataType.timeuuid());
//        getConnector().changeColumnType(ConstantsTest.TABLE_NAME_1, TestDataBuilder.getAlterColumnInput(columnName, ColumnType.BLOB));
//    }
//
//    @Test
...
//        cassClient.addNewColumn(ConstantsTest.TABLE_NAME_1, cassConfig.getKeyspace(), columnName, DataType.timeuuid());
//        getConnector().changeColumnType(ConstantsTest.TABLE_NAME_1, TestDataBuilder.getAlterColumnInput(columnName, ColumnType.UUID));
//    }
//
//    @Test
...
//        cassClient.addNewColumn(ConstantsTest.TABLE_NAME_1, cassConfig.getKeyspace(), columnName, DataType.varchar());
//        getConnector().changeColumnType(ConstantsTest.TABLE_NAME_1, TestDataBuilder.getAlterColumnInput(columnName, ColumnType.BLOB));
//    }
//
//    @Test
...
//        cassClient.addNewColumn(ConstantsTest.TABLE_NAME_1, cassConfig.getKeyspace(), columnName, DataType.blob());
//        getConnector().changeColumnType(ConstantsTest.TABLE_NAME_1, TestDataBuilder.getAlterColumnInput(columnName, ColumnType.TEXT));
//    }
//
//    @Test(expected=InvalidConfigurationInQueryException.class)
...
//        cassClient.addNewColumn(ConstantsTest.TABLE_NAME_1, cassConfig.getKeyspace(), columnName, DataType.blob());
//        getConnector().changeColumnType(ConstantsTest.TABLE_NAME_1, TestDataBuilder.getAlterColumnInput(columnName, ColumnType.ASCII));
//    }
//
//    @Test(expected=InvalidConfigurationInQueryException.class)
...
//        cassClient.addNewColumn(ConstantsTest.TABLE_NAME_1, cassConfig.getKeyspace(), columnName, DataType.blob());
//        getConnector().changeColumnType(ConstantsTest.TABLE_NAME_1, TestDataBuilder.getAlterColumnInput(columnName, ColumnType.INT));
//    }
//
//    @Test(expected=InvalidConfigurationInQueryException.class)
...
//        cassClient.addNewColumn(ConstantsTest.TABLE_NAME_1, cassConfig.getKeyspace(), columnName, DataType.blob());
//        getConnector().changeColumnType(ConstantsTest.TABLE_NAME_1, TestDataBuilder.getAlterColumnInput(columnName, ColumnType.TIMEUUID));
//    }
//
//    @Test(expected=InvalidConfigurationInQueryException.class)
