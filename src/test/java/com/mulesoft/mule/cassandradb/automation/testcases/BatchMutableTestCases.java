...
public class BatchMutableTestCases extends CassandraDBTestParent {

    @Before
    public void setUp() throws Exception {

        initializeTestRunMessage("batchMutableTestData");
    ...
    @Test
    public void testBatchMutable() {

        try {
            runFlowAndGetPayload("batch-mutable");
