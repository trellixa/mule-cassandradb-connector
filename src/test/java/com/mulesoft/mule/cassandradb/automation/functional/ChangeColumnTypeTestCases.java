...
public class ChangeColumnTypeTestCases extends CassandraDBConnectorAbstractTestCase {
    ...
    public void testChangeTypeFromAsciiToBlobWithSuccess() throws CassandraDBException {
        ...
        getConnector().changeColumnType(ConstantsTest.TABLE_NAME, TestDataBuilder.getAddNewColumnInput(columnName, DataType.blob().toString()));
    }
    ...
    public void testChangeTypeFromAsciiToTextWithSuccess() throws CassandraDBException {
        ...
        cassClient.addNewColumn(ConstantsTest.TABLE_NAME, cassConfig.getKeyspace(), columnName, DataType.ascii());
        getConnector().changeColumnType(ConstantsTest.TABLE_NAME, TestDataBuilder.getAddNewColumnInput(columnName, DataType.text().toString()));
    }
    ...
    public void testChangeTypeFromAsciiToVarcharWithSuccess() throws CassandraDBException {
        ...
        cassClient.addNewColumn(ConstantsTest.TABLE_NAME, cassConfig.getKeyspace(), columnName, DataType.ascii());
        getConnector().changeColumnType(ConstantsTest.TABLE_NAME, TestDataBuilder.getAddNewColumnInput(columnName, DataType.varchar().toString()));
    }
    ...
    public void testChangeTypeFromBigintToTimestampWithSuccess() throws CassandraDBException {
        ...
        cassClient.addNewColumn(ConstantsTest.TABLE_NAME, cassConfig.getKeyspace(), columnName, DataType.bigint());
        getConnector().changeColumnType(ConstantsTest.TABLE_NAME, TestDataBuilder.getAddNewColumnInput(columnName, DataType.timestamp().toString()));
    }
    ...
    public void testChangeTypeFromBigintToVarintWithSuccess() throws CassandraDBException {
        ...
        cassClient.addNewColumn(ConstantsTest.TABLE_NAME, cassConfig.getKeyspace(), columnName, DataType.bigint());
        getConnector().changeColumnType(ConstantsTest.TABLE_NAME, TestDataBuilder.getAddNewColumnInput(columnName, DataType.varint().toString()));
    }
    ...
    public void testChangeTypeFromTimestampToBigintWithSuccess() throws CassandraDBException {
        ...
        getConnector().changeColumnType(ConstantsTest.TABLE_NAME, TestDataBuilder.getAddNewColumnInput(columnName, DataType.bigint().toString()));
    }
    ...
    public void testChangeTypeFromTimeuuidToUuidWithSuccess() throws CassandraDBException {
        ...
        cassClient.addNewColumn(ConstantsTest.TABLE_NAME, cassConfig.getKeyspace(), columnName, DataType.timeuuid());
        getConnector().changeColumnType(ConstantsTest.TABLE_NAME, TestDataBuilder.getAddNewColumnInput(columnName, DataType.uuid().toString()));
    }
    ...
    public void testChangeTypeFromBlobToAscii() throws CassandraDBException {
        ...
        cassClient.addNewColumn(ConstantsTest.TABLE_NAME, cassConfig.getKeyspace(), columnName, DataType.blob());
        getConnector().changeColumnType(ConstantsTest.TABLE_NAME, TestDataBuilder.getAddNewColumnInput(columnName, DataType.ascii().toString()));
    }
    ...
    public void testChangeTypeFromBlobToInt() throws CassandraDBException {
        ...
        cassClient.addNewColumn(ConstantsTest.TABLE_NAME, cassConfig.getKeyspace(), columnName, DataType.blob());
        getConnector().changeColumnType(ConstantsTest.TABLE_NAME, TestDataBuilder.getAddNewColumnInput(columnName, DataType.cint().toString()));
    }
    ...
    public void testChangeTypeFromBlobToTimeuuid() throws CassandraDBException {
        ...
        cassClient.addNewColumn(ConstantsTest.TABLE_NAME, cassConfig.getKeyspace(), columnName, DataType.blob());
        getConnector().changeColumnType(ConstantsTest.TABLE_NAME, TestDataBuilder.getAddNewColumnInput(columnName, DataType.timeuuid().toString()));
    }
