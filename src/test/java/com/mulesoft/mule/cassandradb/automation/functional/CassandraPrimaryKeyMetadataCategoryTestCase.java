...
import com.mulesoft.mule.cassandradb.metadata.CassandraPrimaryKeyMetadataCategory;
...
public class CassandraPrimaryKeyMetadataCategoryTestCase extends AbstractMetaDataTestCase<CassandraDBConnector> {

    private static CassandraClient cassClient;
    private static CassandraConfig cassConfig;

    public CassandraPrimaryKeyMetadataCategoryTestCase() {
        super(TestDataBuilder.cassandraCategoryMetadataTestKeys, CassandraPrimaryKeyMetadataCategory.class, CassandraDBConnector.class);
    }
    @BeforeClass
