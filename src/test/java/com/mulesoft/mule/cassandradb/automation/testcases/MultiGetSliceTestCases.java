...
public class MultiGetSliceTestCases extends CassandraDBTestParent {

    @Before
    public void setUp() throws Exception {

        initializeTestRunMessage("multiGetSliceTestData");
    ...
    public void testMultiGetSlice() {
        try {
            Object data = runFlowAndGetPayload("multiget-slice");
