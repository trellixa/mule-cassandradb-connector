...
public class GetIndexedSlicesTestCases extends CassandraDBTestParent {

    @Before
    public void setUp() throws Exception {
        initializeTestRunMessage("getIndexedSlicesTestData");
    ...
    @Test
    public void testGetIndexedSlices() {
        try {
            Object data = runFlowAndGetPayload("get-indexed-slices");
