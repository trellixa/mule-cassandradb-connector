...
/**
 * A <code>CassandraDBConnectorLifecycleInjectionAdapter</code> is a wrapper around {@link CassandraDBConnector } that adds lifecycle methods to the pojo. This adapter also allows the injection of several Mule facilities when a MuleContext is set.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.1", date = "2017-05-30T02:13:49-03:00", comments = "Build UNNAMED.2797.33dc1d7")
public class CassandraDBConnectorLifecycleInjectionAdapter
    extends CassandraDBConnectorMetadataAdapter
    implements MuleContextAware, Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(CassandraDBConnectorLifecycleInjectionAdapter.class);
