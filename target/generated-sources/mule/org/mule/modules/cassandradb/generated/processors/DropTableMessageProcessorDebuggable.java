...
public class DropTableMessageProcessorDebuggable
    extends DropTableMessageProcessor
    implements DebugInfoProvider
{


    public DropTableMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("tableName", "Table name", (java.lang.String.class), tableName, muleEvent));
