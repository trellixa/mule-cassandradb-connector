...
public class DropKeyspaceMessageProcessorDebuggable
    extends DropKeyspaceMessageProcessor
    implements DebugInfoProvider
{


    public DropKeyspaceMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
