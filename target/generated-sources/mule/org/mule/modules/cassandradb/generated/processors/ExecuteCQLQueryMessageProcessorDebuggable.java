...
public class ExecuteCQLQueryMessageProcessorDebuggable
    extends ExecuteCQLQueryMessageProcessor
    implements DebugInfoProvider
{


    public ExecuteCQLQueryMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("input", "Input", (org.mule.modules.cassandradb.metadata.CQLQueryInput.class), input, muleEvent));
