...
public class CreateKeyspaceMessageProcessorDebuggable
    extends CreateKeyspaceMessageProcessor
    implements DebugInfoProvider
{


    public CreateKeyspaceMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("input", "Input", (org.mule.modules.cassandradb.metadata.CreateKeyspaceInput.class), input, muleEvent));
