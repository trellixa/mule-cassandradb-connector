...
public class CreateTableMessageProcessorDebuggable
    extends CreateTableMessageProcessor
    implements DebugInfoProvider
{


    public CreateTableMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("input", "Input", (org.mule.modules.cassandradb.metadata.CreateTableInput.class), input, muleEvent));
