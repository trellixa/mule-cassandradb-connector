...
public class DeleteColumnsValueMessageProcessorDebuggable
    extends DeleteColumnsValueMessageProcessor
    implements DebugInfoProvider
{


    public DeleteColumnsValueMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("payload", "Payload", (java.util.Map.class), payload, muleEvent));
