...
public class ChangeColumnTypeMessageProcessorDebuggable
    extends ChangeColumnTypeMessageProcessor
    implements DebugInfoProvider
{


    public ChangeColumnTypeMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("input", "Input", (org.mule.modules.cassandradb.metadata.AlterColumnInput.class), input, muleEvent));
