...
public class UpdateMessageProcessorDebuggable
    extends UpdateMessageProcessor
    implements DebugInfoProvider
{


    public UpdateMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("entity", "Entity", (java.util.Map.class), entity, muleEvent));
