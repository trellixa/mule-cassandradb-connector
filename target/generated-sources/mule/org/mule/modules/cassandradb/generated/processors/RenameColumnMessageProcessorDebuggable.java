...
public class RenameColumnMessageProcessorDebuggable
    extends RenameColumnMessageProcessor
    implements DebugInfoProvider
{


    public RenameColumnMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("newColumnName", "New column name", (java.lang.String.class), newColumnName, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("oldColumnName", "Old column name", (java.lang.String.class), oldColumnName, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("keyspaceName", "Keyspace name", (java.lang.String.class), keyspaceName, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("table", "Table", (java.lang.String.class), table, muleEvent));
